...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/SumitAwatade1718', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/sumit-awatade-938622275/', label: 'LinkedIn' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/sumit1718/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:awatadesumit1718@gmail.com', label: 'Email' },
  ];
